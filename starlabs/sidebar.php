...
<!--
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Find</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="" data-bs-toggle="modal" data-bs-target="#AddPayment">
  ...
  -->
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-bar-chart"></i><span>Performance Reports</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      ...
      <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="icons-remix.html">
            <i class="bi bi-circle"></i><span>Release Items</span>
          </a>
        </li>
        <li>
          <a href="icons-boxicons.html">
            <i class="bi bi-circle"></i><span>See Stock</span>
          </a>
        </li>
      </ul>
    </li>
