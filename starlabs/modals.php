  ...
  <div class="modal-dialog">
    <div class="modal-content rounded-corner">
      ...
      <div class="modal-body">
        <form id="FNewCourse">
          <div class="mb-3">
            <label for="State-Name" class="col-form-label">Name</label>
            <input type="text" class="form-control rounded-corner" id="CourseName">
          </div>
          <div class="mb-3">
            <label for="State-Code" class="col-form-label">Price</label>
            <input type="number" class="form-control rounded-corner" id="CoursePrice">
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary SaveCourse">Save</button>
      </div>
    </div>
  </div>
</div>