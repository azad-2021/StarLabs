...
<body>
  ...
  <main>
            ...
            <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3 rounded-corner">
                ...
                <div class="card-body">
                  ...
                  <br>
                  <div class="col-12">
                    <button class="btn btn-primary w-100 rounded-corner LoginStudent">Login</button>
                  </div>
                  <div class="col-12">
                    <p class="small mb-0">Don't have account? <a href="StudentRegistration.php">Create an account</a></p>
                  </div>
    ...
    <script type="text/javascript">
      ...
      $(document).on('click', '.LoginStudent', function(){
        ...
        if (UserName!='' && Password != '') {
          ...
          $.ajax({
           ...
           method:"POST",
           data:{'UserName':UserName, 'Password':Password, 'Type':'Student'},
           success:function(results){
            ...
            if (data>0) {
              ...
              window.open("/Admin/students/index.php","_self");
            }
          }
        });
